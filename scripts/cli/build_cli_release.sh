...
if [[ "$SKIP_CHECKS" != "true" ]]; then
  ...
  if curl -s --stderr /dev/null --output /dev/null --head -f "https://github.com/yeap-finance/aptos-core/releases/download/aptos-cli-v$EXPECTED_VERSION/aptos-cli-$EXPECTED_VERSION-Ubuntu-22.04-x86_64.zip"; then
